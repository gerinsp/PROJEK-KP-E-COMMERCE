        ...
        <div class="col-md-12 mt-4">
            <div class="card mb-3">
                ...
                <div class="card-footer">
                    <a href="<?= base_url('/') ?>" class="btn btn-warning text-white"><i class="fas fa-arrow-alt-circle-left">

                        </i> Kembali Belanja</a>
                    <a href="<?= base_url('/checkout') ?>" class="btn btn-success float-end">Pembayaran <i class="fas fa-arrow-alt-circle-right"></i></a>
