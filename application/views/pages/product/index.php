                        ...
                        <form action="<?= base_url("product/search") ?>" method="POST">
                            <div class="input-group">
                                ...
                                <div class="input-group-append">
                                    ...
                                    <a href="<?= base_url("product/reset") ?>" class="btn btn-secondary btn-sm ms-1"><i class="fa fa-eraser"></i></a>
                        ...
                        <tbody>
                            ...
                            foreach ($content as $row) : $no++; ?>
                                <tr>
                                    ...
                                    <td>
                                        <p>
                                            <img src="<?= $row->image ? base_url("images/product/$row->image") : base_url("images/product/deafult.png") ?>" alt="" width="50">
                                            <?= $row->product_title ?>
                                        </p>
                                    </td>
                                    <td>
